...
target.build_configurations.each do |config|
  ...
  config.build_settings["INFOPLIST_KEY_NSHealthUpdateUsageDescription"] = "TRMNL Health Sync does not add, change, or delete Apple Health data. HealthKit access is used only to read the activity data you choose to share."
